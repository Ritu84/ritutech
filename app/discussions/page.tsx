...
export default function DiscussionsPage(): JSX.Element {
  ...
  const renderDiscussionsList = () => {
    ...
    if (!response?.discussions?.length) {
      return (
        <div className="p-4 text-theme-green-500 bg-theme-green-50 rounded text-sm flex items-center gap-2 border border-theme-green-200">
          ...
          {showNewDiscussionForm ? (
            <div className="create-new-discussion-form-container flex items-center justify-between p-2 border rounded-md mb-12 gap-12">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  className="text-sm text-white flex gap-2 items-center bg-theme-pink-400 border hover:bg-theme-pink-600 px-1.5 py-0.5 rounded-md w-fit ml-auto active:bg-theme-pink-700 disabled:opacity-50"
